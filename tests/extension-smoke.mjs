...
const names = new Set(["opl-footer", "opl-init", "opl-input", "opl-modes", "opl-questionnaire", "opl-todo", "opl-webaccess"]);
assert.ok(names.has(extension), `unknown extension: ${extension}`);
...
if (extension === "opl-init") {
  ...
  for (const heading of ["What this is", "Commands", "Architecture", "Key files"]) {
