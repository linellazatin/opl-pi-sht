...
- **`opl-footer`** surfaces model, cost, token and cache activity, git state, and per-turn timing in a configurable multi-row footer; `/configure-opl` edits its layout interactively.
